...
import '../tela_Locador/homepage_locador.dart';

class drawerLocador extends StatefulWidget {
  const drawerLocador({Key? key, required this.scaffoldKey});
...
class _drawerState extends State<drawerLocador> {
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(
              onTap: () {
                Navigator.pushReplacementNamed(context, "/homepage_locador");
              },
            ...
            ListTile(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const homepage_locador(initialIndex: 1),
                  ),
                );
              },
            ...
            ListTile(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const homepage_locador(initialIndex: 2),
                  ),
                );
              },
